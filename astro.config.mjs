...
export default defineConfig({
  ...
  integrations: [sitemap(), astroImageTools, compress({
    css: true,
    html: true,
    js: true,
    img: false,
...
astroImageTools.hooks['astro:build:done'] = async () => (await import('./node_modules/astro-imagetools/plugin/hooks/closeBundle.js')).default();